...
@media(max-width:720px){
  ...
  /* Prevent long repo names / URLs from busting out horizontally */
  .spread h2,.spread h1,.cover-title{word-break:break-word;overflow-wrap:break-word}

  /* --- 01 HERO --- */
  .s-hero{padding:0}
  .s-hero .masthead{
    padding:62px 20px 14px; /* 44px nav + 18px breathing room */
  ...
  /* --- 02 MIDNIGHT --- */
  .s-midnight .bg-num{font-size:44vw;right:-4vw;top:8%;opacity:.45}
  ...
  .s-rose .numeral-xl{font-size:20vw;line-height:.85;margin:10px 0 -4px}
  ...
  .s-academic .body-lead::first-letter{font-size:clamp(36px,10vw,52px);margin:4px 8px 0 -2px}
  ...
  .s-stat .stat-value{font-size:22vw;line-height:.85}
  ...
  /* --- 08 NEON --- */
  .s-neon .numeral-slash{font-size:28vw;-webkit-text-stroke-width:1.5px}
  ...
  /* --- 09 ZINE --- */
  .s-zine .marker-num{font-size:24vw}
  ...
  /* --- 10 PULLQUOTE --- */
  .s-pullquote .quote-open{font-size:28vw;line-height:.72;margin:0 0 -4px -2px}
  ...
  .s-riso .riso-num{font-size:24vw}
